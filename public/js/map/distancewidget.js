...
function DistanceWidget(opt_options) {
  ...
  //Carson
  google.maps.event.addListener(marker, 'dragend',updatePositionByDraggingMarker);
  
  marker.bindTo('map', this);
  marker.bindTo('zIndex', this);
  marker.bindTo('position', this);
  //marker.bindTo('icon', this);
  //marker.bindTo('icon', home_icon);

  // Create a new radius widget
  radiusWidget = new RadiusWidget(options['distance'] || 50);
